...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/favicon/favicon5.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/favicon/favicon6.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#00bcd4">
  <meta name="msapplication-TileImage" content="images/favicon/favicon7.png">
  <!-- For Windows Phone -->
...
<body>
                        ...
                        echo '<tr>
                                ...
                                <td>
                                    <div class="input-field col s12">
                                        ...
                                        <input id="' . $row["id"] . '" name="' . $row['id'] . '" type="number" value="0"  data-error=".errorTxt' . $row["id"] . '">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2024 <a class="grey-text text-lighten-4" href="#" target="_blank">TONLINE</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">TONLINE</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
