...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2017 <a class="grey-text text-lighten-4" href="#" target="_blank">TONLINEs</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">TONLINEs</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
    ...
    $("#formValidate").validate({
        ...
        messages: {
			...
			{  
				...
				min: "Minimum item price is SAR. 0"
				},';				
			}
		echo '},';
		?>
    ...
    $("#formValidate1").validate({
		...
		name: {
		 ...
		 price: {
				...
				minlength: "Minimum item price is SAR.0"
			},
	},
		errorElement : 'div',
        errorPlacement: function(error, element) {
