...
<div id="work-collections" class="seaction">
							...
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>SAR. '.$row['total'].'</strong></span>
                                            </div>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2024 <a class="grey-text text-lighten-4" href="#" target="_blank">TONLINEs</a> All rights reserved.</span>
